        ...
        def buscar(evento):
            ...
            if lista_nota_buscar == True:
                ...
                def editar_b(evento):
                    ...
                    self.entrada_titulo_eb = CTkEntry(self.frame_editab, width=212, corner_radius=10, border_color=cbp, placeholder_text_color=cbp, text_color="black", fg_color=cf, font=fonte_eb)
                    self.texto_eb = CTkTextbox(self.frame_editab, width=210, height=170, border_width=2, border_color=cbp, corner_radius=10, text_color="black", fg_color=cf, font=fonte_eb)
                ...
                self.botao_cria_nota = CTkOptionMenu(self.frame_guarda_notas, values=["Nota"], fg_color=cls, height=25, cursor="hand2", corner_radius=19, button_color=cls, text_color=ctb, button_hover_color=ch,dropdown_fg_color=cls, dropdown_text_color=ctb, dropdown_hover_color=ch, command=escolha_comecar_b)
                self.botao_cria_nota.set("Começar...")
                self.botao_cria_nota.place(x=2, y=33)
                self.campo_busca = CTkEntry(self.frame_guarda_notas, width=162, corner_radius=10, border_color=cbp,placeholder_text_color=cbp, text_color="black", fg_color=cf, placeholder_text="Busque por...")
                ...
                for lnb in lista_nota_buscar:
                    ...
                    if len(texto) > 34:
                        ...
                        texto = texto[0:34]
                    frame_anotacao_b = CTkFrame(self.frame_notas, width=180, height=120, corner_radius=15, cursor="hand2", fg_color=cn)
        ...
        def notas():
            ...
            def escolha_comecar(escolha):
                if escolha == "Nota":
                    ...
                    self.botao_salvar = CTkButton(self.frame_anota, text="Salvar", fg_color=cls, width=4, height=22, border_color="black", border_width=2, corner_radius=23, cursor="hand2", command=salvar_texto, hover_color=ch)
                    self.botao_salvar.place(x=230, y=235)
                    self.botao_ler = CTkButton(self.frame_anota, text="Ler", fg_color=cls, width=4, height=22, image=leitura, border_color="black", border_width=2, corner_radius=23, cursor="hand2", command=ler_GUI, hover_color=ch)
